...
# Bootstrap samples
(foreach SUFFIX, t_E w_E t_symE w_symE, ${PICKLE_DIR}/pkl_bs_%_${SUFFIX}) &: ${DATA_DIR}/WF_% | ${PICKLE_DIR}
	python src/produce_bs_sample.py $^

# Table 1
TAB1_OUTPUT = ${TABLES_DIR}/table1.tex
${TAB1_OUTPUT} : $(foreach SUFFIX, 2_20_2.55 2_24_2.60 2_24_2.62 2_32_2.65 2_32_2.70 4_20_7.7 4_20_7.72 4_20_7.76 4_20_7.78 4_20_7.80 4_20_7.85 4_24_8.2 6_18_15.75 6_16_15.9 6_16_16.1 6_20_16.3 8_16_26.5 8_16_26.7 8_16_27.0 8_16_27.2, ${DATA_DIR}/WF_${SUFFIX}) | ${TABLES_DIR}
	bash src/table1.sh ${DATA_DIR} ${TE} ${WE} $@

# Figure 1
FIG1_OUTPUT = $(foreach SUFFIX, 16_15.9 16_16.1, ${DATA_DIR}/WF_6_${SUFFIX})
${PLOT_DIR}/non_scaled_flows_%.pdf : ${DATA_DIR}/WF_% (foreach SUFFIX, t_E w_E t_symE w_symE, ${PICKLE_DIR}/pkl_bs_%_${SUFFIX}) | ${PLOT_DIR}
...
FIG2_RAW_DEPS = $(foreach SUFFIX,${FIG2_NC$1_SUFFIXES},${DATA_DIR}/WF_$1_${SUFFIX}.dat)
...
FIG3_4_INPUTS = $(foreach SUFFIX,2_20_2.55 2_32_2.70 4_20_7.7 4_24_8.2 6_18_15.75 6_16.3 8_16_26.5 8_16_27.2,${DATA_DIR}/WF_${SUFFIX})

${PLOT_DIR}/flows_%_scaled.pdf : ${FIG3_4_INPUTS} | ${PLOT_DIR}
	PLOT_DIR=${PLOT_DIR} python src/vis_WF_N_scaling.py $$(echo $* | sed "s/_/ /") $^

# Figure 5
FIG5_OUTPUT = ${PLOT_DIR}/TCvst_8_16_26.7.pdf

${PLOT_DIR}/TCvst_%.pdf : ${DATA_DIR}/WF_% | ${PLOT_DIR}
...
FIG6789_DEPS = $(foreach SUFFIX, ${FIG6789_NC$1_SUFFIXES}, ${DATA_DIR}/WF_$1_${SUFFIX})
...
${TAB456_OUTPUT} ${CHIVT0_INT} &: $(foreach NC, 2 4 6 8, $(foreach SUFFIX,FIG2_NC${NC}_SUFFIXES,${DATA_DIR}/WF_${NC}_${SUFFIX})) | ${TABLES_DIR} ${PROC_DIR}
